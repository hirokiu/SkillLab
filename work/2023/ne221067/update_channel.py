...
import re       #正規表現を行うためのモジュール

api_key = 'OUNFDSLTU585ERSK'#ここには自分のAPIキーを打ち込む
channle_id = '2261789'#ここも自分のやつ
data_file = "cpu_temp.dat"#cpu_temp.datは今回温度を読み込むと作成される温度のでーたのやつ
